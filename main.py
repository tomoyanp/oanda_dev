...
if __name__ == '__main__':
    ...
    if test_args == "test":
        ...
        end_time = datetime.strptime("2018-07-07 00:00:00", "%Y-%m-%d %H:%M:%S")
        base_time = datetime.strptime("2018-07-06 03:00:00", "%Y-%m-%d %H:%M:%S")
        #base_time = datetime.strptime("2018-07-03 18:30:00", "%Y-%m-%d %H:%M:%S")
        test_mode = True
    else:
        base_time = datetime.now()
        test_mode = False
