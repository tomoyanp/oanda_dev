            ...
            if 1 == 1:
                if 1 == 1:
                    if 1 == 1:
                        ...
                        if self.sma1h100 < self.sma1h20 and self.decidePerfectOrder() == "buy" and current_price < (self.sma1h100 + 2.0) and self.max_price_1d < self.upper_sigma_1d2:
                        ...
                        elif self.sma1h100 > self.sma1h20 and self.decidePerfectOrder() == "sell" and current_price > (self.sma1h100 - 2.0) and self.min_price_1d > self.lower_sigma_1d2:
