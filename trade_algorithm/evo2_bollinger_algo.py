...
#　２－３）短期トレンドの確認（5分足 50日移動平均線の傾き）
#　２－４）現在価格と5分足 200日移動平均線の比較（上にいれば買い、下にいれば売り）
#　２－５）現在価格がbollinger 3シグマにヒットしている場合、trade_before_flagをONにする
#  ２－６）trade_before_flagがONの状態＆現在価格が2シグマ内に収まった状態でエントリーする
