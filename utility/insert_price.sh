...
nohup python /home/tomoyan/staging/oanda_dev/insert_indicator_master.py "GBP_JPY" > /dev/null &
#sleep 60
#nohup python /home/tomoyan/staging/oanda_dev/insert_price.py "NZD_JPY" > /dev/null &
